...
::: {.Definition #dbinom title="Distribución binomial"}
...
::: {.Definition #dpois title="Distribución de Poisson"}
Una variable aleatoria $N$ que toma valores en $\N$ se dice que sigue una distribución 
...
::: {.Definition #dnbinom title="Distribución binomial negativa"}
Una variable aleatoria $N$ que toma valores en $\N$ se dice que sigue una distribución 
...
::: {.Definition #dgeo title="Distribución geométrica"}
Una variable aleatoria $N$ que toma valores en $\N$ se dice que sigue una distribución 
...
::: {.Definition #fampanjer title="Familia de Panjer"}
...
::: {.Proposition #chfampanjer title="Caracterización familia de Panjer"}
...
::: {.Definition #dunif title="Distribución uniforme"}
...
::: {.Definition #dexp title="Distribución exponencial"}
...
::: {.Definition #dgamma title="Distribución gamma"}
...
::: {.Definition #dnorm title="Distribución normal"}
...
::: {.Definition #dlnorm title="Distribución log-normal"}
...
::: {.Definition #dgpd title="Distribución de Pareto generalizada"}
...
::: {.Definition #dgev title="Distribución de valores extremos generalizada"}
...
::: {.Definition #dtst title="Distribución t de Student"}
...
::: {.Definition #dgammatra title="Distribución gamma transformada"}
...
::: {.Definition #dbetra title="Distribución beta transformada"}
...
::: {.Definition #destconsis title="Estimadores consistentes"}
...
::: {.Definition #destinsesg title="Estimadores insesgados"}
...
::: {.Definition #destefi title="Estimador más eficiente"}
...
::: {.Definition #destsufic title="Estimador suficiente"}
...
::: {.Theorem #thfactorsufic title="Teorema de factorización" }
...
::: {.Definition #dfamicomp title="Familia completa"}
...
::: {.Definition #dpowertest title="Test más potente"}
