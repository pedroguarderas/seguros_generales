...
:::{.Definition #defconcep title="Conceptos de base"}
...
<!------------------------------------------------------------------------------------------------->
::: {.Definition #event title="Espacio muestral y eventos"}
...
:::{.Definition #probmed title="Medida de probabilidad"}
...
:::{.Definition #dctp title="Casi en todas partes"}
...
:::{.Definition #va title="Variable aleatoria"}
...
:::{.Definition #vad title="Variable aleatoria discreta"}
...
:::{.Definition #cd title="Función de distribución acumulada"}
...
:::{.Definition #spv title="Función supervivencia"}
...
Existe una relación interesante entre la función de supervivencia y la esperanza de la variable 
aleatoria $X$. Cuando se da el caso que la variable aleatoria $X$ solo toma valores non-negativos
$X \geq 0$. Por una parte tenemos la siguiente igualdad para cualquier $y \geq 0$
$$
S_X( y ) y =\int\limits_0^y d( x S_X( x ) ) 
= \int\limits_0^y x\ dS_X( x ) + \int\limits_0^y S_X( x )\ dx
$$

En el límite $\underset{y \rightarrow +\infty}{\lim} S_X( y ) y = 0$ y por otra parte
$$
\int\limits_0^y x\ dS_X( x )
= - \int\limits_0^y x\ dF_X( x )
$$
y por tanto uniendo estos dos resultados
$$
\int\limits_0^y x\ dF_X( x ) = \int\limits_0^y dS_X( x ) - S_X( y ) y
$$

si tomamos límites cuando $y \rightarrow +\infty$
$$
\E[ X ] 
= \int\limits_0^{+\infty} x\ dF_X( x )
= \underset{y \rightarrow +\infty}{\lim} \int\limits_0^y x\ dF_X( x )
= \underset{y \rightarrow +\infty}{\lim} \left( \int\limits_0^y dS_X( x ) - S_X( y )y \right)
= \int\limits_0^{+\infty} dS_X( x )
$$

Es decir hay otra forma de calcular la esperanza matemática de una variable aleatoria $X$ 
non-negativa, utilizando su función de supervivencia $S_X$.
...
:::{.Definition #denp title="Función de densidad de probabilidad"}
...
:::{.Definition #ind title="Independencia de variables aleatorias"}
...
:::{.Definition #indicatriz title="Función indicatriz"}
...
:::{.Definition #probemp title="Medida de probabilidad empírica"}
...
:::{.Definition #despva title="Esperanza de una variable aleatoria"}
...
:::{.Definition #mgf title="Función generadora de momentos"}
...
:::{.Definition #dfc title="Función característica"}
...
::: {.Theorem #tdinver title="Inversión"}
...
:::{.Definition #dvarva title="Varianza de una variable aleatoria"}
...
:::{.Definition #defcov title="Covarianza"}
...
:::{.Definition #dsum title="Distribución de la suma de variables aleatorias"}
...
:::{.Definition #dprobcond title="Probabilidad condicional"}
...
:::{.Definition #ddistcond title="Distribución acumulada condicionada"}
...
:::{.Definition #despcond title="Esperanza condicionada"}
...
:::{.Definition #dexceso titlej="Distribución de exceso condicionada"}
...
:::{.Definition #dvarcond title="Varianza condicionada"}
...
::: {.Proposition #dlawtotvar title="Ley de la varianza total"}
...
:::{.Definition #defmixdis title="Mixtura de distribuciones"}
...
::: {.Theorem #twln title="Ley débil de los grandes números"}
...
::: {.Theorem #tlc title="Teorema del límite central"}
...
al \ref{tlc} se debe considerar otros resultados asociados a desigualdades de concentración.
...
::: {.Theorem #tglican title="Teorema de Glivenko-Cantelli"}
...
::: {.Proposition #chebdes title="Desigualdad de Chebyshev"}
...
::: {.Theorem #beress title="Desigualdad de Berry-Esséen"}
...
El teorema del límite central \ref{tlc} no proporciona un criterio para determinar cuan 
rápido se realiza la convergencia hacia la distribución normal. El resultado de la desigualdad 
anterior \ref{beress} si proporciona un criterio de la convergencia eso sí, bajo la 
...
Así mismo, el teorema \ref{tglican} asegura un convergencia, sin embargo no da un 
...
::: {.Theorem #ddkw title="Desigualdad Dvoretzky–Kiefer–Wolfowitz"}
...
Acorde a la desigualdad \ref{ddkw}, para tener un probabilidad baja de aproximación 
...
teorema del límite central \ref{tlc}. Generaremos una simulación aleatoria de la suma
...
::: {.Theorem #dchernoff title="Desigualdad de Chernoff"}
...
::: {.Theorem #dpaleyzyg title="Desigualdad de Paley-Zygmund"}
...
:::{.Definition #dfouriertrans title="Tansformada de Fourier"}
...
:::{.Definition #dsecuencia title="Familia de secuencias finitas"}
...
:::{.Definition #dfouriertransd title="Tansformada de Fourier discreta"}
...
:::{.Definition #deffact title="Funciones de atualización y capitalización"}
