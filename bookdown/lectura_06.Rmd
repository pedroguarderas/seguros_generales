...
5. $K$ Coste de capital, esencialmente el retorno mínimo esperado por los inversores sobre el 
capital invertido.
...
perspectiva probabilista esto se puede realizar seleccionando un nivel de conbertura $\alpha > 0$, 
