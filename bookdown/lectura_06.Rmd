...
```{r l6g1, out.width='80%', fig.align='center', class.source = 'fold-hide'}
smax <- 2.0e5
...
```{r l6g2, out.width='80%', fig.align='center', class.source = 'fold-hide'}
ylim <- c( 0, 1 )
...
$$
```{r l6g3, out.width='80%', fig.align='center', class.source = 'fold-hide'}
...
$$
```{r l6g4, out.width='80%', fig.align='center', class.source = 'fold-hide'}
...
$$
```{r l6g5, out.width='80%', fig.align='center', class.source = 'fold-hide'}
...
```{r l6g6, out.width='80%', fig.align='center', class.source = 'fold-hide'}
smax <- lambda * M
fmax <- 0.002
...
```{r l6g7, out.width='80%', fig.align='center', class.source = 'fold-hide'}
Smax <- ESmax
...
```{r l6g8, out.width='80%', fig.align='center', class.source = 'fold-hide'}
fmax <- 0.0007
...
```{r l6g9, out.width='80%', fig.align='center', class.source = 'fold-hide'}
...
```{r l6g10, out.width='80%', fig.align='center', class.source = 'fold-hide'}
plt <- ggplot() +
...
```{r l6g11, out.width='80%', fig.align='center', class.source = 'fold-hide'}
plt <- ggplot() +
  geom_line( aes( x = s, y = Fs ), colour = 'darkred', linewidth = 1 ) + 
  geom_point( aes( x = s, y = FS ), colour = 'olivedrab3', size = 0.2 ) + 
...
```{r l6g12, out.width='80%', fig.align='center', class.source = 'fold-hide'}
e <- fS - fs
eb <- max( abs( e ) )
...
```{r l6g13, out.width='80%', fig.align='center', class.source = 'fold-hide'}
fmax <- 0.0007
smax <- 5e3
...
```{r l6g14, out.width='80%', fig.align='center', class.source = 'fold-hide'}
...
```{r l6g15, out.width='90%', fig.align='center', class.source = 'fold-hide'}
plt <- ggplot( ) +
...
grupos de riesgo.
```{r l6g16, out.width='90%', fig.align='center', class.source = 'fold-hide'}
xlim <- c( 0, 1e3 )
...
```{r l6g17, out.width='80%', fig.align='center', class.source = 'fold-hide'}
...
```{r l6g18, out.width='80%', fig.align='center', class.source = 'fold-hide'}
...
```{r l6g19, out.width='80%', fig.align='center', class.source = 'fold-hide'}
FeSdat <- NULL
for ( j in 1:p ) {
