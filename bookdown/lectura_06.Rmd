...
De forma algo más formal, un **deducible** es una función $D : \R \longrightarrow \R$ a valores 
reales, tal que para todo valore real $x \in \R$, se satisface la siguiente desigualdad 
$D( x ) \leq x$.
:::
::::

A continuación presentamos un lista de funciones deducibles, de algunos de los tipos de deducibles
más comunes que se presenta en el mercado.
