...
<!------------------------------------------------------------------------------------------------->
## Temporalidad y ajustes de los reclamos totales
...
$$
\ell( \lambda ) = - \lambda \sum\limits_{i=1}^m ER_i 
...
\end{eqnarray*}
$$
En los tres casos anteriores, hemos realizado un ajuste a las distribuciones de la frecuencia 
de los reclamos, tomando en cuenta la exposición al riesgo de cada una de las pólizas a las que 
corresponde.
...
```{r l6g13, out.width='90%', out.height='700px', fig.align='center', class.source = 'fold-hide'}
plt <- ggplot( ) +
...
```{r l6g15, out.width='80%', out.height='450px', fig.align='center', class.source = 'fold-hide'}
