...
aleatorias que siguen una distribución $LN( \mu, \sigma )$ y un número de $n = 10000$ reclamos. 
...
# no hay forma analítica para la distribución de la suma de log-normales
FS <- ecdf( S ) 
