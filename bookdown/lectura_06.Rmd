...
plt <- ggplot() +
  geom_step( aes( x = s, y = Fms ), colour = 'dodgerblue3',  linewidth = 0.8 ) +
  geom_line( aes( x = s, y = Fmax ), colour = 'olivedrab3', linewidth = 0.4 ) +
  geom_line( aes( x = s, y = Fmin ), colour = 'olivedrab3', linewidth = 0.4 ) +
