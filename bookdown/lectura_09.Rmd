...
extremos simulados se cero y habrá sido inútil el haber realizado una estimación más compleja con 
valores extremos, ya que no se la está utilizando en las simulaciones. En tales circunstancias es 
mucho mejor utilizar algún algoritmo determinista que supere este problema.
