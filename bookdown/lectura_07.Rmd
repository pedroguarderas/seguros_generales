...
$\widetilde{\varepsilon} \leq s\min\left( F( \xi_{\alpha} + \varepsilon ) - \alpha, \alpha - F( \xi_{\alpha} - \varepsilon ) \right)$, la expresión anterior se modifica a la siguiente
$$
...
$\widetilde{\varepsilon}$, se requiere un orden de simulaciones cuadrático inverso a este valor.
