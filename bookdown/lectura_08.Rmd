...
```{r l8t1, echo = TRUE, results = 'asis', out.width='80%', class.source = 'fold-hide'}
...
```{r l8t2, echo = TRUE, results = 'asis', out.width='80%', class.source = 'fold-hide'}
dat <- tidy( model_N )
dat %>%
  kable(
...
```{r l8t3, echo = TRUE, results = 'asis', out.width='80%', class.source = 'fold-hide'}
dat <- glance( model_N )
dat %>%
  kable(
    caption = "Resultados del modelo GLM",
