...
:::: {.thmbox data-latex=""}
::: {.definition #dfamexp name="Familia exponencial"}
...
:::: {.thmbox data-latex=""}
::: {.definition #dglm name="Modelo lineal generalizado (GLM)"}
...
::: {.example #l8ex1 name="Regresión de Poisson"}
...
```{r l9t1, echo = TRUE, results = 'asis', out.width='100%', class.source = 'fold-hide'}
...
```{r l9t2, echo = TRUE, results = 'asis', out.width='100%', class.source = 'fold-hide'}
dat <- tidy( model_N )
dat %>%
  kable(
    label = NA,
...
```{r l9t3, echo = TRUE, results = 'asis', out.width='100%', class.source = 'fold-hide'}
dat <- glance( model_N )
dat %>%
  kable(
    label = NA,
