...
estim <- merge.data.table( estim_frec[ , list( grp, EN, SDN ) ], 
                           estim_sev[ , list( grp, EX, SDX ) ], by = 'grp' )
```
El valor esperados del reclamo total por cada grupo $g$ está dado por
$$
\E\left[ S_g \right] = n_g \E\left[ N_g \right] \E\left[ X_g \right]
= `r formatC( 0, digits = 4, format = 'f' )`
$$
Bajo el mismo razonamiento, el valor esperado del reclamo total
$$
\E\left[ S \right]
