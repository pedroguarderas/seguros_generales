...
deducible es de evitar valores de reclamo en determinados rangos que no están acorde a las 
...
se coloca una cota mínima para de tal forma que el asegurado se haga cargo por su cuenta por 
estos valores.

Es usual colocar mínimos en las colas de la distribución de reclamos, evitando así o valores muy 
pequeños valores muy grandes, pero no sería sustentable, ni financieramente o económicamente el 
colocar un deducible justo donde se contratar la mayor parte de los valores de reclamos. Desde
la perspectiva de un asegurado, ¿De qué serviría adquirir una póliza que no cubre precisamente los
siniestros más usuales?. 
