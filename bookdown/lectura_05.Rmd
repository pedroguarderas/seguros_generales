...
En la misma información se incluye el deducible $d$ y el monto de máximo de cobertura.
...
sev_claims <- claims[ , list( DX = sum( claim ) ), by = list( policy, id, idc, type, sex, bdate, cdate ) ]
