...
$$
\{ f_{S}( s_k ) \}
\approx  \Re\left( \sum\limits_{n=1}^{M} \DFT^{-1}\left[ \left\{ \frac{1}{h} \exp\left( 2\pi i \omega_j a \right) 
\prod\limits_{i=1}^n \hat{f}_{i,j} \right\} \right]\ p_n\right),
\qquad \forall s_k > 0
$$
...
e <- cumsum( fS[ -1 ] * diff( sg ) ) - ecdf( S )( sg )
