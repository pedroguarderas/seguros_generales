...
## Prima de percentiles para un valor de confianza $\alpha \in [0,1]$ o prima de valor en riesgo 
$VaR_\alpha$
\begin{equation}
  P = VaR_\alpha( S ) =  F_S^{-1}( \alpha )
\end{equation}

## Prima de valor en riesgo en la cola (Tail Value at Risk) $TVaR_\alpha$. Es el promedio uniforme
