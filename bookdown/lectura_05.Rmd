...
Para cada simulación $i \in \{1,\ldots,m\}$, tomamos una muestra $X_{i,1}, \ldots, X_{i,N_{i,p}}$ de 
tamaño $N_{i,p}$ de los reclamos, los cuales son i.i.d con distribución de probabilidad $F_X$
...
$$
F_{S(t_l)}( s ) \approx F_{m,l}( s ) = \frac{1}{m} \sum\limits_{i=1}^m \mathbf{1}_{(-\infty,s]}\left( S_{i,l} \right)
$$
```{r l5c8}
...
plt <- ggplot( ) +
  ...
  scale_y_continuous( breaks = seq( 0, 1, length = 11 ),
                      labels = formatC( seq( 0, 1, length = 5 ), digits = 2, format = 'f' ), 
