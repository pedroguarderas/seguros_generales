...
estim_frec <- estim_frec[ , list( grp, a, p = a / ( a + EN ), EN, loglik, aic, bic )]
```
...
estim_frec %>%
  kable(
    ...
    row.names = FALSE,
    col.names = c( '$g$', '$\\alpha$', '$p$', '$\\E[ N ]$', '$\\ell( n, p )$', '$AIC$', '$BIC$' ),
    align = 'lrrrrrr',
    digits = c( 0, 5, 5, 5, 5, 2, 2 ),
    format.args = list( big.mark = ',', decimal.mark = '.', scientific = FALSE ),
    escape = FALSE,
    centering = TRUE ) %>%
  kable_classic( font_size = 14, full_width = FALSE, html_font = "Cambria", position = "center" ) %>%
...
estim_sev %>%
  kable(
    ...
    caption = 'Estimación de frecuencia',
    row.names = FALSE,
    col.names = c( '$g$', '$\\mu$', '$\\sigma$', '$\\ell( \\mu, \\sigma )$', '$\\E[ X ]$', '$\\sqrt{\\V[ X ]}$' ),
    align = 'lrrrrrr',
    digits = c( 0, 5, 5, 5, 2, 2 ),
    format.args = list( big.mark = ',', decimal.mark = '.', scientific = FALSE ),
    escape = FALSE,
    centering = TRUE ) %>%
  kable_classic( font_size = 14, full_width = FALSE, html_font = "Cambria", position = "center" ) %>%
