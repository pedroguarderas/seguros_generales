...
```{r l5g4, out.width='80%', out.height='400px', fig.align='center', class.source = 'fold-hide'}
e <- fS - fSx
eb <- max( abs( e ) )
...
```{r l5g7, out.width='80%', out.height='500px', fig.align='center', class.source = 'fold-hide'}
FeSdat <- NULL
for ( j in 1:p ) {
