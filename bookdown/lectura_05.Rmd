...
presentamos los resultados de la estimación.
...
mejor distribución, debemos hacer uso de la forma extendida \@ref(eq:loglik). La función de 
verosimilitud logarítmica toma la siguiente forma:
$$
\begin{eqnarray*}
\ell( \mu, \sigma )
