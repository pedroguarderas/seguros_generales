...
$\mathbb{1}_A( \omega ) = 0$, si $\omega \notin A$ y $\mathbb{1}_A( \omega ) = 1$, si 
$\omega \in A$.
:::

La función indicatriz $1_A$ sobre un evento $A$ del espacio muestral $\Omega$, también se puede
...
\begin{equation}
\mathbb{E}\left[ \mathbb{1}_A \right] 
= \int\limits_\Omega \mathbb{1}_A( \omega )\ dP( \omega )
