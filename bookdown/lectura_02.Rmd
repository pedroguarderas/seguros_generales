...
```{r l2c2, include = FALSE}
options( width = 120 )

knitr::opts_chunk$set(size = 'footnotesize', dpi = 100, warning = FALSE, echo = TRUE, cache = TRUE, class.source = "numberLines lineAnchors")
