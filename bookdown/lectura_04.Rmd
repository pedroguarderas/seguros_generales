...
$$
```{r l4g1, warning=FALSE, out.width='80%', fig.align='center', class.source = 'fold-hide'}
n <- 1e3
x <- seq( -6, 6, length = n )
...
```{r l4g2, warning=FALSE, out.width='80%', fig.align='center', class.source = 'fold-hide'}
plt <- ggplot() +
...
```{r l4g3, warning=FALSE, out.width='80%', fig.align='center', class.source = 'fold-hide'}
dat <- NULL
for ( k in 1:n ) {
