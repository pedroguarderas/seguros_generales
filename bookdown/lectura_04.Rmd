...
útil se requiere reducir el error de probabilidad. Acorde a la desigualdad \@ref(thm:ddkw), para 
tener un probabilidad baja de aproximación $\delta > 0$ en un error de discrepancia $\varepsilon >0$,
necesitamos satisfacer la desigualdad.
\begin{eqnarray*}
2 e^{-2n \varepsilon^2 } & \leq & \delta \\
2n \varepsilon^2 & \geq & -\ln\left( \frac{\delta}{2} \right) \\
n & \geq & -\frac{1}{2\varepsilon^2} \ln\left( \frac{\delta}{2} \right)
\end{eqnarray*}
