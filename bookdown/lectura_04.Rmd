...
El teorema \@ref(thm:tglican) asegura un convergencia, sin embargo no da un estimativo de la 
rapidez de dicha convergencia conforme aumenta el valor $n$, el siguiente resultado es más claro 
al respecto y proporciona un criterio de convergencia.
