...
\end{eqnarray*}
$$
maximizar $\ell_h$ es equivalente a maiximizar la siguiente función equivalente
$$
\begin{eqnarray*}
\ell_h( \theta )
...
\end{eqnarray*}
$$
donde $h$ es constante. Tomando al límite, un valor $h$ cada vez más pequeño, para encerrar aún más
en un intervalo los valores observados, tenemos lo siguiente:
$$
\begin{eqnarray*}
...
el punto $x_i$. Recordamos que toda función de distribución es continua por derecha.
...
solo el primer término la estimación por verosimilitud del mejor parámetro $\theta$ no será la 
correcta.
