...
```{r l4g1, out.width='80%', out.height='500px', fig.align='center', class.source = 'fold-hide'}
plt <- ggplot() +
...
```{r l4g2, out.width='80%', out.height='500px', fig.align='center', class.source = 'fold-hide'}
plt <- ggplot() +
  geom_point( aes( x = 1:n, y = v ), colour = 'darkred' ) + 
  xlab( TeX( "$k$" ) ) + 
  ylab( TeX( "$k \\frac{p_k}{p_{k-1}}$" ) ) + 
...
```{r l4g3, out.width='80%', out.height='500px', fig.align='center', class.source = 'fold-hide'}
plt <- ggplot() +
  geom_point( aes( x = 1:n, y = v ), colour = 'darkred' ) + 
  xlab( TeX( "$k$" ) ) + 
  ylab( TeX( "$k \\frac{p_k}{p_{k-1}}$" ) ) + 
...
```{r l4g4, out.width='80%', out.height='500px', fig.align='center', class.source = 'fold-hide'}
plt <- ggplot() +
