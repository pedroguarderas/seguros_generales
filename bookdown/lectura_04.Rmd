...
$$
```{r l4g1, out.width='80%', fig.align='center', class.source = 'fold-hide'}
n <- 1e3
x <- seq( -6, 6, length = n )
...
```{r l4g2, out.width='80%', fig.align='center', class.source = 'fold-hide'}
plt <- ggplot() +
...
```{r l4g3, out.width='80%', fig.align='center', class.source = 'fold-hide'}
dat <- NULL
for ( k in 1:n ) {
...
```{r l4g4, out.width='80%', fig.align='center', class.source = 'fold-hide'}
...
```{r l4g5, out.width='80%', fig.align='center', class.source = 'fold-hide'}
e <- f - IFf
