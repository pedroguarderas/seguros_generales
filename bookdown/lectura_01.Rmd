...
Las presentes notas han sido creadas para el curso de **Matemática Actuarial de los 
...
Estas trabajo se ha realizado en colaboración entre Leonardo Vélez y Pedro Guarderas. La motivación
y objetivo para haber creado las presentes notas es llegar a generar un buen material de aprendizaje 
y referencia. En el estado actual, no son aún definitivas, están sujetas a mejoras y correcciones.
