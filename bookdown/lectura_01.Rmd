...
@LossModFur, @modevquant, @MathAssuNV1, @MathAssuNV2. Utilizaremos algunos otras referencias de 
soporte, que serán de utilidad para quien desee profundizar con más detalle en algunos conceptos 
@funmathstat, @prinsrisk, @QRisk:2015, @KNight, @mathstat1, @mathstat2. En cuanto a la parte
computacional, haremos uso del paquete para R, @actuar.
