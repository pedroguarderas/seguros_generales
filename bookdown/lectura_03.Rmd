...
::: {.definition #dcondexp name="Esperanza condicional"}
Si consideramos un evento cualquiera $A \in \mathcal{F}$, $X$ una variable aleatoria a valores 
reales y $x \in \R$, consideremos la probabilidad condicionada del siguiente evento
$$
...
::: {.theorem #tdinver name="Inversion"}
