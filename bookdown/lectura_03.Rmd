...
necesidad de **medir** ¿cuántos y cuánto costarán los '*pocos siniestros*' que deberá pagar un seguro?, 
y por ende, cuantificar '*cuál es el monto de la prima*' que debo recolectar de la cartera de asegurados.

Existen dos disciplinas que se ocupan de estos problemas: la *estadística* y la *teoría de probabilidades*. 
...
En la actualidad, el negocio de los seguros solo puede comprenderse a la luz de estas dos ramas, 
cuyos orígenes se remontan a la correspondencia entre Blaise Pascal y Chevalier de Méré, antes de ser 
formalizadas por la escuela rusa liderada por Kolmogorov durante la Segunda Guerra Mundial.
...
aleatorios o es conocida o se pueden calcular de forma deductiva por medio del razonamiento lógico.
...
el concepto de variable aleatoria. Para el actuario, esta puede representar el coste de un siniestro 
o el número de siniestros. 
...
basan en análisis de información histórica, porque esta no existe o es limitada:
