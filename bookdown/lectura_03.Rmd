...
```{r l3g3, out.width='80%', out.height='400px', fig.align='center', class.source = 'fold-hide'}
e <- f - IFf
eb <- max( abs( e ) )
...
```{r l3g4, out.width='80%', out.height='400px', fig.align='center', class.source = 'fold-hide'}
plt <- ggplot() +
