...
Ya que estamos trabajando con series $\{x_k\}$, para medir la aproximación entre una serie $\{x_k\}$
y otra series $\{y_k\}$, de igual dimensión; podemos utilizar la norma cuadrática.
\begin{equation}
